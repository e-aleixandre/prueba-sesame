 ...
 */
final class Version20211119155807 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE work_entry CHANGE user_id_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE work_entry CHANGE user_id user_id_id INT NOT NULL');
        $this->addSql('ALTER TABLE work_entry ADD CONSTRAINT FK_3DAE65F9D86650F FOREIGN KEY (user_id_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
